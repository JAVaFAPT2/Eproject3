...
export default function Header({ search, setSearch, onAdd }) {
  ...
  return (
    <Flex px="25px" py="10px" justify="space-between" align="center">
      <Text fontSize="22px" fontWeight="700" color={textColor}>Goods Receipts</Text>
      <Flex gap={2}>
        <SearchBar placeholder="Search receipts..." value={search} onChange={(e) => setSearch(e.target.value)} />

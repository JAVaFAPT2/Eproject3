...
import EmployeeStanding from 'views/admin/dashboard/components/EmployeeStanding';
...
export default function Dashboard() {
  ...
  useEffect(() => {
    const fetchTop = async () => {
      try {
        const now = new Date();
        const data = await DashboardService.getTopEmployees({
